...
Events.mixin(hgviewer.prototype);
var Class = require('js-class');
module.exports = hgvviewer = Class(
/** @lends Biojs.HGVViewer# */
{
    ...
    autoScaler: function() {
        ...
        Class.console.log("Data Array creation: " + String(endTime-startTime) + " ms");
        startTime  = this._getTime();
        this._createVariantInfoArray();
        endTime = this._getTime();
        Class.console.log("Variant Info Array creation: " + String(endTime-startTime) + " ms");
        var maxTotalVariants = this.getMaximumByType("total");
        Class.console.log("Max total variants: " + maxTotalVariants);
        ...
        Class.console.log("MIN freq: " + this.minimumFrequency);
        ...
        Class.console.log("Max Freq: " + this.maximumFrequency);
    ...
    getData: function(){
        ...
        this._queue.await(function(error, results) {
            if(error){
                ...
                Class.console.log("Error fetching variants"+error);
    ...
    _init: function(proteinID){
        ...
        Class.console.log("Active Scores: " + this._activeScores);
    ...
    _mouseOutEvent: function(d){
        ...
        this.trigger( "onMouseLeaveVariant" ,{
                            "residue": d.residue,
                            "total": d.total,
                            "position": d.position,
                            "damaging": d.damaging,
    ...
    _mouseOverEvent: function(d, _isZoomActive){
        ...
        this.trigger( "onMouseOverVariant" ,{
                            "residue": d.residue,
                            "total": d.total,
                            "position": d.position,
                            "damaging": d.damaging,
    ...
    **/
    plotZoomedOverview: function(position){
        ...
        endTime = this._getTime();
        Class.console.log("SVG drawing: " + String(endTime-startTime) + "ms");
    },
    /**
    ...
    **/
        ...
        if(isOverview){
         ...
         for(var i=1 ; i<this.sequenceLength+1; i+=1){
            ...
            svg.append("rect")
                ...
                .datum(variant)
                .on("mouseover", function(d){
                    Class.console.log("position: " + d.position);
                })
                .on("mousemove", function(d){
                    Class.console.log("position: " + d.position);
                });
    ...
    updateClassOfMutationsVisible: function(obj){
        ...
        this.activeMutationTypes.sort();
        Class.console.log("Active types: " + this.activeMutationTypes)
    ...
    _updateTypeOfScores: function(obj){
        ...
        this.variantParser();
        this.autoScaler();
        this.trigger("onScoringFunctionChange",{
    ...
    variantParser: function(){
        ...
        for (d in variants){
            ...
            if (prediction == null){
                    Class.console.log("ERROR!: prediction null, check: " + position + ", with score:  "  + averageScore + " key " + range  );
            }
            var variantInfo = {};
