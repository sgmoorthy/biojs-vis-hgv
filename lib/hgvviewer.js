...
/** @lends Biojs.HGVViewer# */
{
    constructor: function(options){
        ...
        proteinID = this.opt.accession;
        // this is only for a show case - this is not reusable!
        if(this.opt.accession == undefined){
          proteinID = location.href.split("?q=")[1];
        }
    ...
    /**
     * Method to initialise the ruler line
     **/
    ...
    /**
     * Method to initialise SVG for overview
     **/
    _initSVG: function(){
        var that = this;
...
Events.mixin(hgvviewer.prototype);
